...
class LostPawsBackendStack extends Stack {
  constructor(scope, id, props) {
    ...
    */
    ...
    const updateUserPetLostLambda = new lambda.Function(
      this,
      "updateUserPetLost",
      {
        runtime: lambda.Runtime.NODEJS_18_X,
        handler: "updateUserPetLost.handler",
        code: lambda.Code.fromAsset("lib/lambda"),
        layers: [utilsLayer],
        timeout: Duration.seconds(30),
        environment: {
    ...
    petTable.grantReadWriteData(updateUserPetLostLambda);
    updateUserPetLostLambda.addToRolePolicy(
      new PolicyStatement({
        actions: ["cognito-idp:*"],
        resources: [userPool.userPoolArn],
      })
    ...
    const updateUserPetLostCancelLambda = new lambda.Function(
      this,
      "updateUserPetLostCancel",
      {
        runtime: lambda.Runtime.NODEJS_18_X,
        handler: "updateUserPetLostCancel.handler",
        code: lambda.Code.fromAsset("lib/lambda"),
        layers: [utilsLayer],
        timeout: Duration.seconds(30),
        environment: {
    ...
    petTable.grantReadWriteData(updateUserPetLostCancelLambda);
    updateUserPetLostCancelLambda.addToRolePolicy(
      new PolicyStatement({
        actions: ["cognito-idp:*"],
        resources: [userPool.userPoolArn],
      })
    ...
    const deleteUserPetLambda = new lambda.Function(this, "deleteUserPet", {
      runtime: lambda.Runtime.NODEJS_18_X,
      handler: "deleteUserPet.handler",
      code: lambda.Code.fromAsset("lib/lambda"),
      layers: [utilsLayer],
      timeout: Duration.seconds(30),
      environment: {
    ...
    petTable.grantReadWriteData(deleteUserPetLambda);
    deleteUserPetLambda.addToRolePolicy(
      new PolicyStatement({
        actions: ["cognito-idp:*"],
        resources: [userPool.userPoolArn],
      })
    ...
    const updateUserPetLambda = new lambda.Function(this, "updateUserPet", {
      runtime: lambda.Runtime.NODEJS_18_X,
      handler: "updateUserPet.handler",
      code: lambda.Code.fromAsset("lib/lambda"),
      layers: [utilsLayer],
      timeout: Duration.seconds(30),
      environment: {
    ...
    petTable.grantReadWriteData(updateUserPetLambda);
    bucket.grantDelete(updateUserPetLambda);
    bucket.grantReadWrite(updateUserPetLambda);
    updateUserPetLambda.addToRolePolicy(
      new PolicyStatement({
        actions: ["cognito-idp:*"],
        resources: [userPool.userPoolArn],
      })
    ...
    const userPetLost = userPet.addResource("lost");
    const userPetNotLost = userPet.addResource("notLost");

    const pet = pets.addResource("{id}");
    const petImages = pet.addResource("images");
    const lost = pets.addResource("lost");

    const deletePet = userPet.addResource("{id}");

    deletePet.addMethod(
      "DELETE",
      new apigateway.LambdaIntegration(deleteUserPetLambda),
      {
    ...
    userPet.addMethod(
      "PUT",
      new apigateway.LambdaIntegration(updateUserPetLambda),
      {
        authorizer: authorizerCognito,
        authorizationType: apigateway.AuthorizationType.COGNITO,
      }
    ...
    userPetLost.addMethod(
      "PUT",
      new apigateway.LambdaIntegration(updateUserPetLostLambda),
      {
        authorizer: authorizerCognito,
        authorizationType: apigateway.AuthorizationType.COGNITO,
      }
    ...
    userPetNotLost.addMethod(
      "PUT",
      new apigateway.LambdaIntegration(updateUserPetLostCancelLambda),
      {
        authorizer: authorizerCognito,
        authorizationType: apigateway.AuthorizationType.COGNITO,
      }
